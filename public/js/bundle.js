...
const VERSION = exports.VERSION = "1.10.0";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZXBocmVtNjQiLCJhIjoiY21kMzR2NHdxMDB4MDJxczl0MnZ0anZ3dCJ9.UcsapD7cGUM4ocKfKy3Amw';
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var stripe, session, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          stripe = Stripe('pk_test_51RlbblQvY8ZSKutiboJh3xfDUxJojSwmNcKsKLUhX2E2Ap545ZmUTk8Qo1JILHY4oslUIql5L972CnnlZOa7QDre00LZNzt7T3');
          _context.n = 1;
